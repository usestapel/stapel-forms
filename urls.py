"""Root URLconf for stapel-forms — v1 canon mount (api-versioning.md §2).
...
from stapel_forms.urls_v1 import GATE_REGISTRY  # noqa: F401  (re-export)

urlpatterns = [
    path("api/v1/", include("stapel_forms.urls_v1")),
]
